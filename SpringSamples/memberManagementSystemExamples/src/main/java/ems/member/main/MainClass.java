...
public class MainClass {
	public static void main(String[] args) {
		...
		String[] sMajors = {"English Literature", "Korean Language and Literature", "French Language and Literature", "Philsophy", "History", "Law", "Statistics", "Computer", "Economics", "Public Administration"};
